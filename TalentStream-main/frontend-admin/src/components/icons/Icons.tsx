...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.996a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 01.99-1.855l4.5-3.25.045-.03.002-.001.002-.002.001-.002.002-.002.001-.001a2.25 2.25 0 012.25 0l4.5 3.25.001.002.002.002.001.002.002.002.045.03a2.25 2.25 0 01.99 1.855z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 8.48v-3.32a2.25 2.25 0 00-2.25-2.25h-3a2.25 2.25 0 00-2.25 2.25v3.32" />
  </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.512 2.72a3 3 0 01-4.682-2.72 9.094 9.094 0 013.741-.479m-4.5-4.5a3 3 0 011.879-2.72A9.095 9.095 0 0112 5.25v2.25m-3.75 4.5v-2.25a3 3 0 011.879-2.72A9.095 9.095 0 0112 5.25v2.25m0-3a3 3 0 01-3 3m0 0V7.5m3-3v2.25m0 0a3 3 0 013 3m0-3V7.5m-6 3a3 3 0 01-3-3v0a3 3 0 013-3v0a3 3 0 013 3v0a3 3 0 01-3 3z" />
  </svg>
);
...
export const CurrencyDollarIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.95-.754 2.408-.754 3.359 0l.879.659" />
    </svg>
);

export const AcademicCapIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-3.21-2.29m15.482 0l3.21 2.29m-1.2-3.21l-2.13-1.52m-12 0l2.13 1.52M12 6.094v4.5m-3-3.465l-2.13 1.52M15 7.629l2.13 1.52M5.13 15.044a2.25 2.25 0 01-2.248-2.248l.001-9.503a2.25 2.25 0 012.248-2.248h13.744a2.25 2.25 0 012.248 2.248l-.001 9.503a2.25 2.25 0 01-2.248 2.248H5.13z" />
    </svg>
);
...
export const IdentificationIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm-3.75 0h.008v.008h-.008v-.008z" />
  </svg>
);

export const LightBulbIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.25H10.5a6.01 6.01 0 001.5 11.25v5.25m-3-15l-1.06-1.06a.75.75 0 011.06-1.06L9 3.94M16.06 4.94l1.06-1.06a.75.75 0 011.06 1.06L17.12 6M3.94 16.06l1.06 1.06a.75.75 0 01-1.06 1.06L3.94 17.12M19.06 16.06l-1.06 1.06a.75.75 0 01-1.06-1.06L18 15.06M12 21a.75.75 0 01.75.75V24h-1.5v-2.25A.75.75 0 0112 21z" />
  </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.372c-1.034.103-1.933-.417-2.316-1.342l-3.284-6.568c-.383-.925.396-1.942 1.342-2.316l3.722-.372c.884-.088 1.732.41 2.097 1.253zM15.002 6.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.372c-1.034.103-1.933-.417-2.316-1.342l-3.284-6.568c-.383-.925.396-1.942 1.342-2.316l3.722-.372c.884-.088 1.732.41 2.097 1.253z" />
  </svg>
);
...
export const TrashIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09.982-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
    </svg>
);
...
// Fix: Add missing CheckCircleIcon
...
// Fix: Add missing XCircleIcon to resolve import error
...
export const DocumentMagnifyingGlassIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m-1.75 2.25a11.956 11.956 0 01-2.63 3.3c-.309.346-.554.723-.758 1.126C2.904 14.55 2.404 16.22 2.404 18v.003c0 1.141.92 2.06 2.061 2.061h.003c.645 0 1.25-.252 1.698-.698l.01-.011.011-.011c.203-.203.39-.414.557-.63l.168-.223.168-.223c.333-.444.614-.908.835-1.395a11.956 11.956 0 01-2.63-3.3m12.5-3.375a11.956 11.956 0 012.63 3.3c.309.346.554.723.758 1.126 1.026 1.94 1.526 3.61 1.526 5.39v.003c0 1.141-.92 2.06-2.061 2.061h-.003c-.645 0-1.25-.252-1.698-.698l-.01-.011-.011-.011c-.203-.203-.39-.414-.557-.63l-.168-.223-.168-.223c-.333-.444-.614-.908-.835-1.395a11.956 11.956 0 012.63-3.3" />
    </svg>
);
...
export const BanknotesIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5h16.5m-18 3h19.5M4.5 11.25h15m-15 3h15m-15 3h15" />
  </svg>
);
